...
public class AdjustShoppingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.adjust_shopping_activity);

        // Retrieve the Ingredient object from the intent
        ingredient = getIntent().getParcelableExtra("ingredient");

        // Initialize views
        customQuantityEditText = findViewById(R.id.customCartQuantityEditText);
        Button setButton = findViewById(R.id.setCartButton);
        Button addButton = findViewById(R.id.addCartButton);
        Button removeButton = findViewById(R.id.removeCartButton);
        Button closeButton = findViewById(R.id.closeCartButton);
        ...
        removeButton.setOnClickListener(v -> {
            ...
            if (currentQuantity > 0) {
                ...
                DatabaseReference databaseReference = FoodDatabase.getInstance().getFoodRef().child("Cart").child(userId);
                databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            if (storedIngredient.getName().equals(ingredient.getName())) {
                                ...
                                childSnapshot.getRef().removeValue()
                                        .addOnSuccessListener(aVoid -> {
                                            Toast.makeText(AdjustShoppingActivity.this, "Ingredient removed successfully", Toast.LENGTH_SHORT).show();
                                            // Close the activity after successful removal
                                            finish();
                                        })
                                        .addOnFailureListener(e -> {
                                            Toast.makeText(AdjustShoppingActivity.this, "Failed to remove ingredient", Toast.LENGTH_SHORT).show();
                                        });
                                break;
                            }
                        }
                    ...
                    public void onCancelled(DatabaseError databaseError) {
                        ...
                        Toast.makeText(AdjustShoppingActivity.this, "Failed to fetch ingredients", Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
    ...
    private void setCustomQuantity() {
        ...
        if (!customQuantityString.isEmpty()) {
            ...
            Toast.makeText(AdjustShoppingActivity.this, "Please enter a custom quantity", Toast.LENGTH_SHORT).show();
        }
    }
                ...
                for (DataSnapshot childSnapshot : dataSnapshot.getChildren()) {
                    ...
                    if (storedIngredient.getName().equals(ingredient.getName())) {
                        ...
                        childSnapshot.getRef().setValue(storedIngredient)
                                .addOnSuccessListener(aVoid -> {
                                    Toast.makeText(AdjustShoppingActivity.this, "Ingredient quantity updated successfully", Toast.LENGTH_SHORT).show();
                                })
                                .addOnFailureListener(e -> {
                                    Toast.makeText(AdjustShoppingActivity.this, "Failed to update ingredient quantity", Toast.LENGTH_SHORT).show();
                                });
