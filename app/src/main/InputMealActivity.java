...
public class InputMealActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
                ...
                foodDatabase.addMeal(nameText, intCalorieText, userId)
                        .addOnCompleteListener(task -> {
                            if (task.isSuccessful()) {
                                ...
                                Toast.makeText(InputMealActivity.this,
                                "Failed to add meal", Toast.LENGTH_SHORT).show();
                            }
                        });
            } else {
                Toast.makeText(InputMealActivity.this, "User not logged in",
                        Toast.LENGTH_SHORT).show();
            }
        });
        ...
        //Sprint 2 Task 5:
        Button showDailyCalorieIntakeOverPastMonthBtn =
                findViewById(R.id.showDailyCalorieIntakeOverPastMonthBtn);
        Button showComparisonBetweenIntakeAndGoalBtn =
                findViewById(R.id.showComparisonBetweenIntakeAndGoalBtn);
